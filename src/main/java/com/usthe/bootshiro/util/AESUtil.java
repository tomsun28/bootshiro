...
public class AESUtil {
    ...
    private static final String ENCODE_RULES = "tomsun28haha";
     ...
     */
    public static String aesEncode(String content,String encodeRule) {
        try {
     ...
     * @Return java.lang.String
     */
    public static String aesDecode(String content,String encodeRule) {
        try {
            //1.构造密钥生成器，指定为AES算法,不区分大小写
